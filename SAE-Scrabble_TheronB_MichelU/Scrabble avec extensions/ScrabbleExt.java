...
public class Scrabble {
	...
	/*
	 * Méthode qui affiche le plateau courant et le joueur coureant.
	 */
	...
	public void partie() {
		...
		int maxScore=-9999999; //Si aprÃ¨s la soustraction des points de leurs chevalets les scores des joueurs sont nÃ©gatifs, on peut rentrer dans la boucle Si pour afficher le gagnant.
